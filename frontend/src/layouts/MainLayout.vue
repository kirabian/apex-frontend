  ...
  <div class="flex h-screen bg-surface-900 text-slate-300 font-sans antialiased overflow-hidden">
    ...
    <aside
      ...
      <div class="p-6 flex items-center justify-between">
        ...
        <button @click="isMobileMenuOpen = false" class="lg:hidden text-text-secondary hover:text-text-primary">
          <X :size="24" />
        </button>
      </div>
    ...
    <main class="flex-1 flex flex-col min-w-0 bg-surface-900 transition-colors duration-300 relative overflow-hidden">
      ...
      <header
        ...
        <div class="flex items-center gap-4 flex-1">
          <button @click="toggleMobileMenu" class="lg:hidden p-2 text-text-secondary hover:text-text-primary">
            <Menu :size="24" />
          </button>
