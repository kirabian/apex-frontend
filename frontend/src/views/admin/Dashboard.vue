...
const getColorClasses = (color) => {
  // Return unified primary theme colors for all stats
  return {
    bg: "bg-primary-500/20",
    text: "text-primary-600 dark:text-primary-400",
    icon: "bg-primary-500 text-white", // Icon background is primary, icon itself is white
  };
};
</script>
        ...
        <div class="space-y-3">
          ...
          >
            ...
            <div class="flex items-center justify-between mt-2">
              <span
                class="text-amber-600 dark:text-amber-500 text-xs font-semibold"
              >
        ...
        <div class="space-y-3">
          ...
          >
            <div class="flex items-center gap-3">
              <div
                class="w-10 h-10 rounded-xl bg-surface-700 flex items-center justify-center"
              >
